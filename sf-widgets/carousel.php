...
function carousel_posts_widget() {register_widget( 'carousel_widget_exm1' );}

class carousel_widget_exm1 extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'carousel_widget_exm1', // Widget ID
			__('Carousel', 'examiner'), // Name
	...
	<ul class="slides">
		...
		<li <?php post_class((is_sticky()?'sticky':'')); ?>>
			<div class="carousel-image">
				...
				<?php the_post_thumbnail('big-carousel-thumb'); if ( 'video' == get_post_format() ): echo '<span class="play-icon"></span>'; endif;?>
				</a>
				<?php } ?>
			</div>
			<!---carousel-image-->
