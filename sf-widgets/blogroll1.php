...
function blog_category_widget() {register_widget( 'blog_category_exm1' );}

class blog_category_exm1 extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'blog_category_exm1', // Widget ID
			__('Blogroll 1', 'examiner'), // Name
