...
add_action( 'widgets_init', 'blog_category_three_widget' );

function blog_category_three_widget() {register_widget( 'blog_category_three_exm1' );}

class blog_category_three_exm1 extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'blog_category_three_exm1', // Widget ID
			__('Blogroll 3', 'examiner'), // Name
		...
		/* Default widget settings. */
			...
			$defaults = array( 'title' => 'Blogroll3', 'number' => 4, 'offset' => 0, 'author' => '0', 'date' => '0', 'widget_size' => 'two-parts', 'categories' => '0', 'excerptnumber'=>'30', 'cat_show' => 'on', 'navigation'=>'0', 'auto_load' => '0');
...
<div class="blog-category blogroll3">
	<ul>
		<?php 
		...
		if($navigation) {
			...
			$exm1_posts = new WP_Query(array( 'cat' => $categories, 'posts_per_page' => $number, 'offset' => $paged_offset, 'paged'=>$paged ));
			}else{
...
<p>
	<label for="<?php echo esc_attr($this->get_field_id( 'excerptnumber' )); ?>">
		<?php _e('Number of words(max: 120):', 'examiner'); ?>
	</label>
