...
function small_img_widget() {register_widget( 'small_img_cat_exm1' );}

class small_img_cat_exm1 extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'small_img_category_exm1', // Widget ID
			__('Small featured images', 'examiner'), //Name
...
<div id="small-wrapper">
	<ul class="small-category">
		<?php if($review) {$exm1_posts = new WP_Query(array(  'tax_query' => array(array('taxonomy' => 'post_format', 'field' => 'slug', 'terms' => array('post-format-aside'))),'posts_per_page' => $number, 'offset' => $offset ));}
		else
		...
		<li <?php post_class((is_sticky()?'sticky':'')); ?>>
			<div class="small-image">
				...
				<?php the_post_thumbnail('small-image-featured'); if ( 'video' == get_post_format() ): echo '<span class="play-icon"></span>'; endif; ?>
				</a>
				<?php }else{ ?>
				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
			...
			<div class="small-text">
				...
				<div class="small-author">
					<?php echo esc_html(get_option('exm1_word_before_author')); ?>
