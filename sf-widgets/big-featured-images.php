...
function img_feat_widget() {register_widget( 'img_feat_cat_exm1' );}

class img_feat_cat_exm1 extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'img_featured_category_exm1', // Widget ID
			__('Big Featured Images', 'examiner'),  //Name
...
if($navigation) {
		...
		<li <?php post_class((is_sticky()?'sticky':'')); ?>>
			<div class="img-featured-posts-image">
				...
				<?php the_post_thumbnail('image-featured');if ( 'video' == get_post_format() ): echo '<span class="play-icon"></span>'; endif; ?>
				</a>
				<?php }else{ ?>
				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
...
<p>
	<label for="<?php echo esc_attr($this->get_field_id( 'display_text' )); ?>">
		<?php _e('Show content text:', 'examiner'); ?>
	</label>
