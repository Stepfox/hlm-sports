...
class Widget_Shortcode {
	...
	function do_widget( $args ) {
		...
		'before_widget' => '<div class="sports-widget"><div id="' . $container_id . '" class="widget ' . $container_class . '">',
		...
		if ( isset( $widgets_map[$id] ) && !empty($wp_registered_sidebars[ $widgets_map[$id] ]['name']) ) {
