...
$('li[id*="hlm_sports_bestodds"]').unbind('click').live('click', function(e) {
...
$('.widget[id*=hlm_sports_bestodds] .add-row-repeater').unbind('click').live('click', function(e) {
    e.preventDefault();
    ...
    $('li[id*="hlm_sports_bestodds"]').find('input').change();
	});
