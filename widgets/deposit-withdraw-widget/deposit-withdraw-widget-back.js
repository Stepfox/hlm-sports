...
$('li[id*="hlm_sports_deposit_withdraw"]').unbind('click').live('click', function(e) {
...
$('.widget[id*=hlm_sports_deposit_withdraw] .add-row-repeater').unbind('click').live('click', function(e) {
    e.preventDefault();
    ...
    $('li[id*="hlm_sports_deposit_withdraw"]').find('input').change();
	});
