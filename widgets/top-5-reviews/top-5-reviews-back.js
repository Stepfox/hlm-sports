...
$('li[id*="top_5_reviews_hlm_sports"]').unbind('click').live('click', function(e) {
...
$('.widget[id*=top_5_reviews_hlm_sports] .add-row-repeater').unbind('click').live('click', function(e) {
    e.preventDefault();
    ...
    $('li[id*="top_5_reviews_hlm_sports"]').find('input').change();
	});
