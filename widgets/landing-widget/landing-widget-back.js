...
$('li[id*="landing_widget_hlm_sports"]').unbind('click').live('click', function(e) {
...
$('.widget[id*=landing_widget_hlm_sports] .add-row-repeater').unbind('click').live('click', function(e) {
    e.preventDefault();
    ...
    $('li[id*="landing_widget_hlm_sports"]').find('input').change();
	});
