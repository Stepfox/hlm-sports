...
$('li[id*="hlm_sports_faq"]').unbind('click').live('click', function(e) {
...
$('.widget[id*=hlm_sports_faq] .add-row-repeater').unbind('click').live('click', function(e) {
    e.preventDefault();
    ...
    $('li[id*="hlm_sports_faq"]').find('input').change();
	});
